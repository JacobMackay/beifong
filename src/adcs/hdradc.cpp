...
class HDRADC final : public ADC<Float, Spectrum> {
 public:
     ...
     HDRADC(const Properties &props) : Base(props) {
     ...
     void put(const SignalBlock *block) override {
 ...
 protected:
     ...
     fs::path m_dest_file;
     ref<SignalBlock> m_storage;
     std::mutex m_mutex;
     std::vector<std::string> m_channels;
};

MTS_IMPLEMENT_CLASS_VARIANT(HDRADC, ADC)
MTS_EXPORT_PLUGIN(HDRADC, "HDR ADC")
