...
class PointBeam final : public Emitter<Float, Spectrum> {
public:
    MTS_IMPORT_BASE(Emitter, m_flags, m_medium, m_world_transform)
    MTS_IMPORT_TYPES(Scene, Texture)

    PointBeam(const Properties &props) : Base(props) {
...
MTS_IMPLEMENT_CLASS_VARIANT(PointBeam, Emitter)
MTS_EXPORT_PLUGIN(PointBeam, "PointBeam emitter")
