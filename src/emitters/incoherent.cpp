...
class Incoherent final : public Emitter<Float, Spectrum> {
public:
    MTS_IMPORT_BASE(Emitter, m_flags, m_shape, m_medium)
    MTS_IMPORT_TYPES(Scene, Shape, Texture)

    Incoherent(const Properties &props) : Base(props) {
    ...
    Spectrum eval(const SurfaceInteraction3f &si, Mask active) const override {
        ...
        geom_gain *= rcp(6.f)*math::InvPi<Float>;
        // =============================
    ...
    std::pair<Ray3f, Spectrum> sample_ray(Float time, Float wavelength_sample,
        ...
        Spectrum geom_gain = rcp(6.f)*math::InvPi<Float> * pdf;
        // ===========================================
        // ====================================================
    ...
    sample_direction(const Interaction3f &it, const Point2f &sample, Mask active) const override {
        ...
        // =============================
        // 3b. Directional part from WDF in [1/sr] --
        geom_gain *= m_shape->surface_area() *rcp(6.f)*math::InvPi<Float>;
        ds.pdf *= m_shape->surface_area() *rcp(6.f)*math::InvPi<Float>;
        // =============================
    ...
    Float pdf_direction(const Interaction3f &it, const DirectionSample3f &ds,
        ...
        value *= rcp(6.f)*math::InvPi<Float>;
        // =============================
    ...
    void traverse(TraversalCallback *callback) override {
        callback->put_object("radiance", m_antenna_texture.get());
    }
...
MTS_IMPLEMENT_CLASS_VARIANT(Incoherent, Emitter)
MTS_EXPORT_PLUGIN(Incoherent, "Incoherent emitter")
