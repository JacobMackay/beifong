...
class MTS_EXPORT_RENDER SignalBlock : public Object {
public:
     ...
     */
    SignalBlock(const ScalarVector2i &size,
    ...
    void put(const SignalBlock *block);
...
MTS_EXTERN_CLASS_RENDER(SignalBlock)
