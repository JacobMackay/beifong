...
static const char *__doc_mitsuba_ADC =
R"doc(Abstract ADC base class - used to store samples generated by
Integrator implementations.

To avoid lock-related bottlenecks when rendering with many cores,
rendering threads first store results in a "signal block", which is
then committed to the ADC using the put() method.)doc";

static const char *__doc_mitsuba_ADC_2 = R"doc()doc";

static const char *__doc_mitsuba_ADC_3 = R"doc()doc";

static const char *__doc_mitsuba_ADC_4 = R"doc()doc";

static const char *__doc_mitsuba_ADC_ADC = R"doc(Create a ADC)doc";

static const char *__doc_mitsuba_ADC_bitmap = R"doc(Return a bitmap object storing the developed contents of the ADC)doc";

static const char *__doc_mitsuba_ADC_class = R"doc()doc";

static const char *__doc_mitsuba_ADC_window_offset = R"doc(Return the offset of the crop window)doc";

static const char *__doc_mitsuba_ADC_window_size = R"doc(Return the size of the crop window)doc";

static const char *__doc_mitsuba_ADC_destination_exists = R"doc(Does the destination file already exist?)doc";

static const char *__doc_mitsuba_ADC_develop =
R"doc(Develop the ADC and write the result to the previously specified
filename)doc";

static const char *__doc_mitsuba_ADC_develop_2 =
R"doc(Develop the contents of a subregion of the ADC and store it inside
the given bitmap
...
static const char *__doc_mitsuba_ADC_has_high_quality_edges =
R"doc(Should regions slightly outside the image plane be sampled to improve
the quality of the reconstruction at the edges? This only makes sense
when reconstruction filters other than the box filter are used.)doc";

static const char *__doc_mitsuba_ADC_m_window_offset = R"doc()doc";

static const char *__doc_mitsuba_ADC_m_window_size = R"doc()doc";

static const char *__doc_mitsuba_ADC_m_filter = R"doc()doc";

static const char *__doc_mitsuba_ADC_m_high_quality_edges = R"doc()doc";

static const char *__doc_mitsuba_ADC_m_size = R"doc()doc";

static const char *__doc_mitsuba_ADC_prepare = R"doc(Configure the ADC for rendering a specified set of channels)doc";

static const char *__doc_mitsuba_ADC_put =
R"doc(Merge an image block into the ADC. This methods should be thread-
safe.)doc";

static const char *__doc_mitsuba_ADC_reconstruction_filter = R"doc(Return the image reconstruction filter (const version))doc";

static const char *__doc_mitsuba_ADC_set_window = R"doc(Set the size and offset of the crop window.)doc";

static const char *__doc_mitsuba_ADC_set_destination_file = R"doc(Set the target filename (with or without extension))doc";

static const char *__doc_mitsuba_ADC_size =
R"doc(Ignoring the crop window, return the resolution of the underlying
sensor)doc";

static const char *__doc_mitsuba_ADC_to_string = R"doc(//! @})doc";
...
static const char *__doc_mitsuba_SignalBlock =
R"doc(Storage for an image sub-block (a.k.a render bucket)
...
static const char *__doc_mitsuba_SignalBlock_2 = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_3 = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_4 = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_SignalBlock =
R"doc(Construct a new image block of the requested properties
...
Parameter ``filter``:
    Pointer to the ADC's reconstruction filter. If passed, it is used
    to compute and store reconstruction weights. Note that it is
    mandatory when any of the block's put operations are used, except
    for ``put``(const SignalBlock*).
...
Parameter ``normalize``:
    Ensure that splats created via ``SignalBlock::put()`` add a unit
    amount of energy? Stratified sampling techniques that sample rays
    in image space should set this to ``False``, since the samples
    will eventually be divided by the accumulated sample weight to
    remove any non-uniformity.)doc";

static const char *__doc_mitsuba_SignalBlock_border_size = R"doc(Return the border region used by the reconstruction filter)doc";

static const char *__doc_mitsuba_SignalBlock_channel_count = R"doc(Return the number of channels stored by the image block)doc";

static const char *__doc_mitsuba_SignalBlock_class = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_clear = R"doc(Clear everything to zero.)doc";

static const char *__doc_mitsuba_SignalBlock_data = R"doc(Return the underlying pixel buffer)doc";

static const char *__doc_mitsuba_SignalBlock_data_2 = R"doc(Return the underlying pixel buffer (const version))doc";

static const char *__doc_mitsuba_SignalBlock_height = R"doc(Return the bitmap's height in pixels)doc";

static const char *__doc_mitsuba_SignalBlock_m_border_size = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_m_channel_count = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_m_data = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_m_filter = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_m_normalize = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_m_offset = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_m_size = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_m_warn_invalid = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_m_warn_negative = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_m_weights_x = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_m_weights_y = R"doc()doc";

static const char *__doc_mitsuba_SignalBlock_offset = R"doc(Return the current block offset)doc";

static const char *__doc_mitsuba_SignalBlock_put = R"doc(Accumulate another image block into this one)doc";

static const char *__doc_mitsuba_SignalBlock_put_2 =
R"doc(Store a single sample / packets of samples inside the image block.
...
static const char *__doc_mitsuba_SignalBlock_put_3 =
R"doc(Store a single sample inside the block.
...
static const char *__doc_mitsuba_SignalBlock_set_offset =
R"doc(Set the current block offset.

This corresponds to the offset from the top-left corner of a larger
image (e.g. a ADC) to the top-left corner of this SignalBlock
instance.)doc";

static const char *__doc_mitsuba_SignalBlock_set_size = R"doc(Set the block size. This potentially destroys the block's content.)doc";

static const char *__doc_mitsuba_SignalBlock_set_warn_invalid = R"doc(Warn when writing invalid (NaN, +/- infinity) sample values?)doc";

static const char *__doc_mitsuba_SignalBlock_set_warn_negative = R"doc(Warn when writing negative sample values?)doc";

static const char *__doc_mitsuba_SignalBlock_size = R"doc(Return the current block size)doc";

static const char *__doc_mitsuba_SignalBlock_to_string = R"doc(//! @})doc";

static const char *__doc_mitsuba_SignalBlock_warn_invalid = R"doc(Warn when writing invalid (NaN, +/- infinity) sample values?)doc";

static const char *__doc_mitsuba_SignalBlock_warn_negative = R"doc(Warn when writing negative sample values?)doc";

static const char *__doc_mitsuba_SignalBlock_width = R"doc(Return the bitmap's width in pixels)doc";
...
static const char *__doc_mitsuba_Integrator_receive = R"doc(Perform the main signal rendering job. Returns ``True`` upon success)doc";
...
static const char *__doc_mitsuba_ProfilerPhase_SignalBlockPut = R"doc()doc";
...
static const char *__doc_mitsuba_Scene_m_receivers = R"doc()doc";
...
static const char *__doc_mitsuba_Scene_receivers = R"doc(Return the list of receivers)doc";

static const char *__doc_mitsuba_Scene_receivers_2 = R"doc(Return the list of receivers (const version))doc";
...
static const char *__doc_mitsuba_Receiver = R"doc()doc";

static const char *__doc_mitsuba_Receiver_2 = R"doc()doc";

static const char *__doc_mitsuba_Receiver_3 = R"doc()doc";

static const char *__doc_mitsuba_Receiver_4 = R"doc()doc";

static const char *__doc_mitsuba_Receiver_Receiver = R"doc()doc";

static const char *__doc_mitsuba_Receiver_class = R"doc()doc";

static const char *__doc_mitsuba_Receiver_adc = R"doc(Return the ADC instance associated with this receiver)doc";

static const char *__doc_mitsuba_Receiver_adc_2 = R"doc(Return the ADC instance associated with this receiver (const))doc";

static const char *__doc_mitsuba_Receiver_m_adc = R"doc()doc";

static const char *__doc_mitsuba_Receiver_m_resolution = R"doc()doc";
...
static const char *__doc_mitsuba_Receiver_parameters_changed = R"doc()doc";

static const char *__doc_mitsuba_Receiver_sample_ray_differential =
R"doc(Importance sample a ray differential proportional to the receiver's
sensitivity profile.

The receiver profile is a six-dimensional quantity that depends on time,
wavelength, surface position, and direction. This function takes a
given time value and five uniformly distributed samples on the
interval [0, 1] and warps them so that the returned ray the profile.
Any discrepancies between ideal and actual sampled profile are
...
Parameter ``sample3``:
    A uniformly distributed sample on the domain ``[0,1]^2``. This
    argument determines the position on the aperture of the receiver.
    This argument is ignored if ``needs_sample_3() == false``.

Returns:
    The sampled ray differential and (potentially spectrally varying)
    importance weights. The latter account for the difference between
    the receiver profile and the actual used sampling density function.)doc";

static const char *__doc_mitsuba_Receiver_sampler =
R"doc(Return the receiver's sample generator
...
static const char *__doc_mitsuba_Receiver_sampler_2 =
R"doc(Return the receiver's sampler (const version).
...
static const char *__doc_mitsuba_Shape_is_receiver = R"doc(Is this shape also an area receiver?)doc";
...
static const char *__doc_mitsuba_Shape_m_receiver = R"doc()doc";
...
static const char *__doc_mitsuba_Shape_receiver = R"doc(Return the area receiver associated with this shape (if any))doc";

static const char *__doc_mitsuba_Shape_receiver_2 = R"doc(Return the area receiver associated with this shape (if any))doc";
...
static const char *__doc_mitsuba_SurfaceInteraction_is_receiver = R"doc(Is the intersected shape also a receiver?)doc";
