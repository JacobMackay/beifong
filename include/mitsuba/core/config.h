...
#define MTS_EXTERN_STRUCT_CORE(Name)                                            \
    ...
    MTS_EXTERN_CORE template struct MTS_EXPORT_CORE Name<Packet<float>, Color<Packet<float>, 3>>; \
...
#define MTS_EXTERN_CLASS_CORE(Name)                                             \
    ...
    MTS_EXTERN_CORE template class MTS_EXPORT_CORE Name<Packet<float>, Color<Packet<float>, 3>>; \
...
#define MTS_EXTERN_STRUCT_RENDER(Name)                                          \
    ...
    MTS_EXTERN_RENDER template struct MTS_EXPORT_RENDER Name<Packet<float>, Color<Packet<float>, 3>>; \
...
#define MTS_EXTERN_CLASS_RENDER(Name)                                           \
    ...
    MTS_EXTERN_RENDER template class MTS_EXPORT_RENDER Name<Packet<float>, Color<Packet<float>, 3>>; \
